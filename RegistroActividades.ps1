# Definir la ruta del archivo de log en el escritorio (más accesible)
...
Write-Host " 2. Ver registro en vista gráfica (GridView)"
...
switch ($choice) {
    ...
    "2" {
        Write-Host "`nMostrando registro en vista gráfica..." -ForegroundColor Cyan
        if (Test-Path $logFile) {
